...
type RequestPass struct {
	...
	Seed   int64 `protobuf:"varint,1,opt,name=Seed,proto3" json:"Seed,omitempty"`
	Lenght int64 `protobuf:"varint,8,opt,name=Lenght,proto3" json:"Lenght,omitempty"`
}
...
func (x *RequestPass) GetLenght() int64 {
	if x != nil {
		return x.Lenght
	}
	return 0
...
var file_protoapi_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x67, 0x68, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x4c, 0x65, 0x6e,
	0x67, 0x68, 0x74, 0x22, 0x28, 0x0a, 0x0a, 0x52, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x50, 0x61, 0x73,
